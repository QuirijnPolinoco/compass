...
![languages mapped](https://img.shields.io/badge/languages%20mapped-14-success)
...
> **Status:** early but functional. The engine, MCP server, 14 languages, live re-mapping, the
...
```sh
compass --help
compass languages      # lists all 14 languages
```
