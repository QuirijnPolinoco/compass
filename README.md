...
![languages mapped](https://img.shields.io/badge/languages%20mapped-11-success)
...
> **Status:** early but functional. The engine, MCP server, 11 languages, live re-mapping, the
...
```sh
compass --help
compass languages      # lists all 11 languages
```
